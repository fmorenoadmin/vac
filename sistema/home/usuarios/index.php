<?php
	...
	$rut='../../';
	//---------------------------------
	$pagina='Usuarios';$singlr='Usuarios';
	$action='usuarios.php';
	//---------------------------------
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<select name="id_tipo" class="form-control select2"><?= $data->cboTipos; $data->cboTipos = null; ?></select>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Nombre:</label>
									<input type="text" class="form-control" name="nombres_u" required="required">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Apellido:</label>
									<input type="text" class="form-control" name="apellidos_u" required="required">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Contarseña:</label>
									<input type="text" class="form-control" name="contrasenia_u" value="<?= $data->pass; ?>" required="required">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Teléfono:</label>
									<input type="tel" class="form-control" name="telefono_u" required="required">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									<label for="message-text" class="col-form-label">Descripción:</label>
									<textarea class="form-control ckeditor" id="ckeditor" name="descrip_u"></textarea>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
