...
if (SCHU == '_qas') {
	...
	//-------------------------------------------
	define('URL', HTTPS.DOM.D_DIR.'/tc/');//URL PRINCIPALES
	define('URL2', HTTPS.DOM.D_DIR.'/tc');//URL PRINCIPALES
	//-------------------------------------------
	...
	define('D_DIR', '');
	//-------------------------------------------
	define('URL', HTTPS.'tc.'.DOM.D_DIR.'/');//URL PRINCIPALES
	define('URL2', HTTPS.'tc.'.DOM.D_DIR);//URL PRINCIPALES
	//-------------------------------------------
