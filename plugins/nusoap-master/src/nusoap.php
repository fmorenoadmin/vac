...
class soap_transport_http extends nusoap_base
{
     ...
     * @access   private
     */
    function connect($connection_timeout = 0, $response_timeout = 999999)
    {
...
//			$this->setError('cURL Extension, or OpenSSL extension w/ PHP version >= 4.3 is required for HTTPS');
            ...
            if (defined('CURLOPT_CONNECTIONTIMEOUT')) {
                ...
                $CURLOPT_CONNECTIONTIMEOUT = 999999999;
            }
...
//		}
     ...
     * @access   public
     */
    function send($data, $timeout = 0, $response_timeout = 999999, $cookies = null)
    {
     ...
     * @deprecated
     */
    function sendHTTPS($data, $timeout = 0, $response_timeout = 999999, $cookies)
    {
...
class wsdl extends nusoap_base
{
     ...
     * @access public
     */
    function __construct($wsdl = '', $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 999999999, $curl_options = null, $use_curl = false)
    {
        parent::__construct();
...
class nusoap_client extends nusoap_base
{
    ...
    var $timeout = 999999999;                // HTTP connection timeout
    var $response_timeout = 9999;        // HTTP response timeout
     ...
     * @access   public
     */
    function __construct($endpoint, $wsdl = false, $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 999999, $portName = '')
    {
        parent::__construct();
     ...
     * @access   private
     */
    function send($msg, $soapaction = '', $timeout = 0, $response_timeout = 999999999)
    {
        $this->checkCookies();
        // detect transport
        switch (true) {
