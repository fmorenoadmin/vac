    ...
    var w = function(e) {
        function n(r) {
            ...
            o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingCalendar = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function(e) {
                ...
                e.isTouch ? i !== o.component.props.eventSelection && n.dispatch({
                    type: "SELECT_EVENT",
                    eventInstanceId: i
                }) : n.dispatch({
                    type: "UNSELECT_EVENT"
                }), o.isDragging && (n.unselect(e), n.publiclyTrigger("eventDragStart", [{
                    el: o.subjectSeg.el,
                ...
                if (o.isDragging) {
                    ...
                    if (o.clearDrag(), n.publiclyTrigger("eventDragStop", [{
                            el: o.subjectSeg.el,
                            event: g,
                            jsEvent: e.origEvent,
                            view: r
                        ...
                        if (l === n) {
                            ...
                            var S = i({}, v, {
                                ...
                                delta: s.datesDelta,
                                oldEvent: g,
                                event: new t.EventApi(n, h.defs[c.defId], d ? h.instances[d.instanceId] : null),
                                revert: function() {
                                    n.dispatch({
                                        type: "MERGE_EVENTS",
                                        eventStore: u
                            ...
                            l.publiclyTrigger("drop", [y]), l.publiclyTrigger("eventReceive", [{
                                draggedEl: e.subjectEl,
                                event: new t.EventApi(l, h.defs[c.defId], h.instances[d.instanceId]),
                                view: p.component
                            }])
                        }
