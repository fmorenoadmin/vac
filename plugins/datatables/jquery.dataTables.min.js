            ...
            for (e = b.length - 1; 0 <= e; e--) {
                ...
                for (g = q.length; f < g; f++)
                    if ("number" === typeof q[f] && 0 <= q[f]) {
                        ...
                        d(q[f], l)
                    } else if ("number" === typeof q[f] && 0 > q[f]) d(m.length + q[f], l);
    ...
    function Bb(a) {
        ...
        for (f = a.aoData.length; d < f; d++)
            if (h = a.aoData[d], !h._aFilterData) {
                j = [];
                e = 0;
                for (g = b.length; e < g; e++) c = b[e], c.bSearchable ? (i = B(a, d, e, "filter"), m[c.sType] && (i = m[c.sType](i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "", i.indexOf && -1 !== i.indexOf("&") && (wa.innerHTML = i, i = Xb ? wa.textContent : wa.innerText), i.replace && (i = i.replace(/[\r\n\u2028]/g, "")), j.push(i);
                h._aFilterData = j;
        ...
        iterator: function(a, b, c, d) {
            ...
            for (j = m.length; g < j; g++) {
                ...
                if ("table" === b) f = c.call(t, m[g], g), f !== k && e.push(f);
                    ...
                    h = 0;
                    for (l = o.length; h < l; h++) f = o[h], f = "cell" === b ? c.call(t, m[g], f.row, f.column, g, h) : c.call(t, m[g], f, g, h, n), f !== k && e.push(f)
                }
            }
